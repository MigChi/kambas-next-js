   ...
   <Table striped>
    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-total-activity">11:41:34</td></tr>
      ...
      <td className="wd-last-activity">2021-13-11</td>
      <td className="wd-total-activity">9:11:50</td></tr>

      {/* Natasha Romanaoff */}    
      <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          <span className="wd-first-name">Natasha</span>{" "}
          <span className="wd-last-name">Romanaoff</span></td>
      <td className="wd-login-id">001234564S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">TEACHER</td>
      <td className="wd-last-activity">2022-16-12</td>
      <td className="wd-total-activity">10:10:10</td></tr>
    </tbody>
   </Table>
  </div> );}